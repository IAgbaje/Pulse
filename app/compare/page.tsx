...
const SITE_URL = "https://pulse-wheat-six.vercel.app/compare";
...
export default function ComparePage() {
  ...
  const handleCompare = (e: React.FormEvent) => {
    e.preventDefault();
    if (salaryValid) setSubmitted(true);
  };
            ...
            {resultState === "insufficient" && (
              <div className="surface-card text-center py-10">
                ...
                <p className="text-sm text-cream-60 mb-4">
                  We have {grossValues.length} {currency} record{grossValues.length !== 1 ? "s" : ""} for this combination. We need at least 5 for a reliable percentile.
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      {PLATFORMS.map((platform) => (
                        <a
                          key={platform.name}
                          href={platform.buildUrl(shareText, SITE_URL)}
                          target="_blank"
